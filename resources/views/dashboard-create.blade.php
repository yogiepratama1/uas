    ...
    <div class="container mx-auto mt-10">
        <div class="w-full bg-grey-lightest">
            ...
            <div class="container mx-auto p-5">
                <h1 class="font-semibold mb-3 text-2xl">Tambah mahasiswa</h1>
                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" name="nim" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label class="block text-sm font-medium text-gray-700">Password mahasiswa</label>
